/**
 * codepoint_width.c, generated on 2018-07-14.
...
/* Private usage range. */
static const struct codepoint_range codepoint_private_table[] = {
    {0x0E000, 0x0F8FF}, {0xF0000, 0xFFFFD}, {0x100000, 0x10FFFD}
};

/* Nonprinting characters. */
static const struct codepoint_range codepoint_nonprint_table[] = {
...
static const struct codepoint_range codepoint_combining_table[] = {
...
/* Width.2 characters. */
static const struct codepoint_range codepoint_doublewide_table[] = {
...
static const struct codepoint_range codepoint_ambiguous_table[] = {
...
static const struct codepoint_range codepoint_unassigned_table[] = {
...
static const struct codepoint_range codepoint_widened_table[] = {
...
static int in_table(const struct codepoint_range *table, size_t n_items, int c)
{
...
{
    if (in_table(codepoint_private_table, lengthof(codepoint_private_table), c))
        return codepoint_private_use;
    if (in_table(codepoint_nonprint_table, lengthof(codepoint_nonprint_table), c))
        return codepoint_nonprint;
    if (in_table(codepoint_combining_table, lengthof(codepoint_combining_table), c))
        return codepoint_combining;
    if (in_table(codepoint_doublewide_table, lengthof(codepoint_doublewide_table), c))
        return 2;
    if (in_table(codepoint_ambiguous_table, lengthof(codepoint_ambiguous_table), c))
        return codepoint_ambiguous;
    if (in_table(codepoint_unassigned_table, lengthof(codepoint_unassigned_table), c))
        return codepoint_unassigned;
    if (in_table(codepoint_widened_table, lengthof(codepoint_widened_table), c))
        return codepoint_widened_in_9;
    return 1;
}
